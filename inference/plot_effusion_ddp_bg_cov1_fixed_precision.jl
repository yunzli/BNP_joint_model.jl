...
config = TOML.parsefile("../configs/effusion_ddp_cov1_BG_fixed_precision.TOML")
...
alpha0_grids = seq(0, 1, length=100)
alpha0_dens = dbeta(alpha0_grids, a0, b0)
png(paste0(fig_path, "alpha0_hist.png"))
hist(alpha0_save, main="", cex.axis=2, freq=FALSE)
lines(alpha0_dens ~ alpha0_grids, col="red", lwd=2)
dev.off() 
...
zeta0_grids = seq(0, 1, length=100)
zeta0_dens = dbeta(zeta0_grids, a1, b1)
png(paste0(fig_path, "zeta0_hist.png"))
hist(zeta0_save, main="", cex.axis=2, freq=FALSE)
lines(zeta0_dens ~ zeta0_grids, col="red", lwd=2)
dev.off() 
"""
...
png(paste0(fig_path, "beta_predC.png"), height=480, width=480)
hist(unlist(beta_predC[,1]), main="", xlab="", cex.axis=2, xlim=c(-3,3), breaks=seq(-5,5,by=1))
dev.off() 
...
png(paste0(fig_path, "beta_predT.png"), height=480, width=480)
hist(unlist(beta_predT[,1]), main="", xlab="", cex.axis=2, xlim=c(-3,3), breaks=seq(-5,5,by=1))
dev.off() 
...
png(paste0(fig_path, "gamma_predC.png"), height=480, width=480)
hist(unlist(gamma_predC[,1]), main="", xlab="", cex.axis=2, xlim=c(-3,3), breaks=seq(-5,5,by=1))
dev.off() 
...
hist(gap_scaleT, main="", xlab="", cex.axis=2, xlim=c(0,60), breaks=seq(0,2178,by=3))
dev.off()

png(paste0(fig_path, "gamma_predT.png"), height=480, width=480)
hist(unlist(gamma_predT[,1]), main="", xlab="", cex.axis=2, xlim=c(-3,3), breaks=seq(-5,6,by=1))
dev.off() 
