...
config = TOML.parsefile("../configs/effusion_cov_common_atoms_re.TOML")
...
@rput Sigma_e_1_save
R"""
png(paste0(fig_path,"Sigma_e_1_11_trace.png"))
plot(Sigma_e_1_save[,1,1], type='l', cex.axis=2)
dev.off() 

png(paste0(fig_path,"Sigma_e_1_11_hist.png"))
hist(Sigma_e_1_save[,1,1], main="", cex.axis=2)
dev.off() 

png(paste0(fig_path,"Sigma_e_1_12_trace.png"))
plot(Sigma_e_1_save[,1,2], type='l', cex.axis=2)
dev.off() 

png(paste0(fig_path,"Sigma_e_1_12_hist.png"))
hist(Sigma_e_1_save[,1,2], main="", cex.axis=2)
dev.off() 

png(paste0(fig_path,"Sigma_e_1_22_trace.png"))
plot(Sigma_e_1_save[,2,2], type='l', cex.axis=2)
dev.off() 

png(paste0(fig_path,"Sigma_e_1_22_hist.png"))
hist(Sigma_e_1_save[,2,2], main="", cex.axis=2)
dev.off() 
"""

@rput Sigma_e_2_save
R"""
png(paste0(fig_path,"Sigma_e_2_11_trace.png"))
plot(Sigma_e_2_save[,1,1], type='l', cex.axis=2)
dev.off() 

png(paste0(fig_path,"Sigma_e_2_11_hist.png"))
hist(Sigma_e_2_save[,1,1], main="", cex.axis=2)
dev.off() 

png(paste0(fig_path,"Sigma_e_2_12_trace.png"))
plot(Sigma_e_2_save[,1,2], type='l', cex.axis=2)
dev.off() 

png(paste0(fig_path,"Sigma_e_2_12_hist.png"))
hist(Sigma_e_2_save[,1,2], main="", cex.axis=2)
dev.off() 

png(paste0(fig_path,"Sigma_e_2_22_trace.png"))
plot(Sigma_e_2_save[,2,2], type='l', cex.axis=2)
dev.off() 

png(paste0(fig_path,"Sigma_e_2_22_hist.png"))
hist(Sigma_e_2_save[,2,2], main="", cex.axis=2)
dev.off() 
"""
...
plot(epsilon_predC ~ xi_predC, main="", xlab="xi", ylab="epsilon", cex.axis=2, xlim=c(0,25), ylim=c(0,25))
points(epsilon_prior ~ xi_prior, col=rgb(red = 0, green = 0, blue = 1, alpha = 0.5))
dev.off() 
...
plot(epsilon_predT ~ xi_predT, main="", xlab="xi", ylab="epsilon", cex.axis=2, xlim=c(0,25), ylim=c(0,25))
points(epsilon_prior ~ xi_prior, col=rgb(red = 0, green = 0, blue = 1, alpha = 0.5))
dev.off() 
"""
...
survival_predC, gap_predC, arrival_predC, theta_predC, phi_predC, lambda_predC, eta_predC = predict(Sigma_e_1_save, theta_save, phi_save, nl_saveC, lambda_save, eta_save, ml_saveC)

survival_predT, gap_predT, arrival_predT, theta_predT, phi_predT, lambda_predT, eta_predT = predict(Sigma_e_2_save, theta_save, phi_save, nl_saveT, lambda_save, eta_save, ml_saveT)
...
gap_p_surv = gap_p_surv + ylab("Density") + xlab("t") + ylim(0,1)
