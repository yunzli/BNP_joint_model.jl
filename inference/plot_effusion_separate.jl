...
configC = TOML.parsefile("../configs/effusionC_s4.TOML")
configT = TOML.parsefile("../configs/effusionT_s4.TOML")
...
survival_p_surv = survival_p_surv + ylab("Survival") + xlab("t") + ylim(0,1.01)
...
hist(unlist(theta_predT), main="", xlab="", cex.axis=2, xlim=c(0,30), breaks=seq(0,max(unlist(theta_predT))+3,by=3))
dev.off() 

png(paste0(fig_path, "phi_predT.png"), height=480, width=480)
hist(unlist(phi_predT), main="", xlab="", cex.axis=2, xlim=c(0,20), breaks=seq(0,max(unlist(phi_predT))+3,by=3))
dev.off() 
...
hist(unlist(eta_predC), main="", xlab="", cex.axis=2, xlim=c(0,20), breaks=seq(0,max(unlist(eta_predC))+3,by=3))
dev.off() 

png(paste0(fig_path, "lambda_predT.png"), height=480, width=480)
hist(unlist(lambda_predT), main="", xlab="", cex.axis=2, xlim=c(0,60), breaks=seq(0,max(unlist(lambda_predT))+3,by=3))
dev.off() 

png(paste0(fig_path, "eta_predT.png"), height=480, width=480)
hist(unlist(eta_predT), main="", xlab="", cex.axis=2, xlim=c(0,20), breaks=seq(0,max(unlist(eta_predT))+3,by=3))
dev.off() 
"""
