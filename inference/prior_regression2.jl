...
cond_N0_S1_grids1C, cond_N1_S1_grids1C = dpm_conditional_probability_dpre_regression(res3_1, grids_1, [0], [0], theta, beta, phi, w, lambda, gamma, eta, p)
cond_N0_S1_grids2C, cond_N1_S1_grids2C = dpm_conditional_probability_dpre_regression(res3_1, grids_2, [0], [0], theta, beta, phi, w, lambda, gamma, eta, p)
cond_N0_S1_grids3C, cond_N1_S1_grids3C = dpm_conditional_probability_dpre_regression(res3_1, grids_3, [0], [0], theta, beta, phi, w, lambda, gamma, eta, p)

cond_N0_S2_grids1C, cond_N1_S2_grids1C = dpm_conditional_probability_dpre_regression(res3_2, grids_1, [0], [0], theta, beta, phi, w, lambda, gamma, eta, p)
cond_N0_S2_grids2C, cond_N1_S2_grids2C = dpm_conditional_probability_dpre_regression(res3_2, grids_2, [0], [0], theta, beta, phi, w, lambda, gamma, eta, p)
cond_N0_S2_grids3C, cond_N1_S2_grids3C = dpm_conditional_probability_dpre_regression(res3_2, grids_3, [0], [0], theta, beta, phi, w, lambda, gamma, eta, p)

cond_N0_S3_grids1C, cond_N1_S3_grids1C = dpm_conditional_probability_dpre_regression(res3_3, grids_1, [0], [0], theta, beta, phi, w, lambda, gamma, eta, p)
cond_N0_S3_grids2C, cond_N1_S3_grids2C = dpm_conditional_probability_dpre_regression(res3_3, grids_2, [0], [0], theta, beta, phi, w, lambda, gamma, eta, p)
cond_N0_S3_grids3C, cond_N1_S3_grids3C = dpm_conditional_probability_dpre_regression(res3_3, grids_3, [0], [0], theta, beta, phi, w, lambda, gamma, eta, p)

cond_N0_S1_grids1T, cond_N1_S1_grids1T = dpm_conditional_probability_dpre_regression(res3_1, grids_1, [1], [1], theta, beta, phi, w, lambda, gamma, eta, p)
cond_N0_S1_grids2T, cond_N1_S1_grids2T = dpm_conditional_probability_dpre_regression(res3_1, grids_2, [1], [1], theta, beta, phi, w, lambda, gamma, eta, p)
cond_N0_S1_grids3T, cond_N1_S1_grids3T = dpm_conditional_probability_dpre_regression(res3_1, grids_3, [1], [1], theta, beta, phi, w, lambda, gamma, eta, p)

cond_N0_S2_grids1T, cond_N1_S2_grids1T = dpm_conditional_probability_dpre_regression(res3_2, grids_1, [1], [1], theta, beta, phi, w, lambda, gamma, eta, p)
cond_N0_S2_grids2T, cond_N1_S2_grids2T = dpm_conditional_probability_dpre_regression(res3_2, grids_2, [1], [1], theta, beta, phi, w, lambda, gamma, eta, p)
cond_N0_S2_grids3T, cond_N1_S2_grids3T = dpm_conditional_probability_dpre_regression(res3_2, grids_3, [1], [1], theta, beta, phi, w, lambda, gamma, eta, p)

cond_N0_S3_grids1T, cond_N1_S3_grids1T = dpm_conditional_probability_dpre_regression(res3_3, grids_1, [1], [1], theta, beta, phi, w, lambda, gamma, eta, p)
cond_N0_S3_grids2T, cond_N1_S3_grids2T = dpm_conditional_probability_dpre_regression(res3_3, grids_2, [1], [1], theta, beta, phi, w, lambda, gamma, eta, p)
cond_N0_S3_grids3T, cond_N1_S3_grids3T = dpm_conditional_probability_dpre_regression(res3_3, grids_3, [1], [1], theta, beta, phi, w, lambda, gamma, eta, p)
...
R"""
fig_path = "//Users/yunzheli/Research/BNPJoint/figs/prior/analysis_regression2/"
