...
configC = TOML.parsefile("../configs/effusionC_s5.TOML")
configT = TOML.parsefile("../configs/effusionT_s5.TOML")

fig_path = "//Users/yunzheli/Research/BNPJoint/figs/effusion_s5/"
if !isdir(fig_path)
    print(fig_path,"\n")
	mkdir(fig_path)
end
...
@rput mu_theta_saveC b_phi_saveC mu_lambda_saveC b_eta_saveC 
@rput mu_theta_saveT b_phi_saveT mu_lambda_saveT b_eta_saveT 
R"""
png(paste0(fig_path,"mu_thetaC_trace.png"))
plot(mu_theta_saveC, type='l', cex.axis=2)
dev.off()

png(paste0(fig_path,"b_phiC_trace.png"))
plot(b_phi_saveC, type='l', cex.axis=2)
dev.off()

png(paste0(fig_path,"mu_lambdaC_trace.png"))
plot(mu_lambda_saveC, type='l', cex.axis=2)
dev.off()

png(paste0(fig_path,"b_etaC_trace.png"))
plot(b_eta_saveC, type='l', cex.axis=2)
dev.off()

png(paste0(fig_path,"mu_thetaT_trace.png"))
plot(mu_theta_saveT, type='l', cex.axis=2)
dev.off()

png(paste0(fig_path,"b_phiT_trace.png"))
plot(b_phi_saveT, type='l', cex.axis=2)
dev.off()

png(paste0(fig_path,"mu_lambdaT_trace.png"))
plot(mu_lambda_saveT, type='l', cex.axis=2)
dev.off()

png(paste0(fig_path,"b_etaT_trace.png"))
plot(b_eta_saveT, type='l', cex.axis=2)
dev.off()
"""
...
hist(unlist(theta_predC), main="", xlab="", cex.axis=2, breaks=seq(0,max(unlist(theta_predC))+3, by=3), xlim=c(0,30))
dev.off() 

png(paste0(fig_path, "phi_predC.png"), height=480, width=480)
hist(unlist(phi_predC), main="", xlab="", cex.axis=2, breaks=seq(0,max(unlist(phi_predC)+2),by=2))
dev.off() 
...
cond_probC_2 = conditional_survival_probability(
    Sigma_e_saveC, 
    a_etaC,
    eta_saveC, 
    lambda_saveC, 
...
cond_probC_3 = conditional_survival_probability(
    Sigma_e_saveC, 
    a_etaC,
    eta_saveC, 
    lambda_saveC, 
...
cond_probC_4 = conditional_survival_probability(
    Sigma_e_saveC, 
    a_etaC,
    eta_saveC, 
    lambda_saveC, 
...
cond_probT_1 = conditional_survival_probability(
    Sigma_e_saveT, 
    a_etaT,
    eta_saveT, 
    lambda_saveT, 
...
cond_probT_2 = conditional_survival_probability(
    Sigma_e_saveT, 
    a_etaT,
    eta_saveT, 
    lambda_saveT, 
...
cond_probT_3 = conditional_survival_probability(
    Sigma_e_saveT, 
    a_etaT,
    eta_saveT, 
    lambda_saveT, 
...
cond_probT_4 = conditional_survival_probability(
    Sigma_e_saveT, 
    a_etaT,
    eta_saveT, 
    lambda_saveT, 
