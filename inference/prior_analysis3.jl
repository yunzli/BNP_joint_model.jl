...
cond_N0_S1_grids1, cond_N1_S1_grids1 = shared_conditional_probability_fixed(sigma2_e, power1, grids_1, theta, phi, lambda, eta)
cond_N0_S1_grids2, cond_N1_S1_grids2 = shared_conditional_probability_fixed(sigma2_e, power1, grids_2, theta, phi, lambda, eta)
cond_N0_S1_grids3, cond_N1_S1_grids3 = shared_conditional_probability_fixed(sigma2_e, power1, grids_3, theta, phi, lambda, eta)

cond_N0_S2_grids1, cond_N1_S2_grids1 = shared_conditional_probability_fixed(sigma2_e, power2, grids_1, theta, phi, lambda, eta)
cond_N0_S2_grids2, cond_N1_S2_grids2 = shared_conditional_probability_fixed(sigma2_e, power2, grids_2, theta, phi, lambda, eta)
cond_N0_S2_grids3, cond_N1_S2_grids3 = shared_conditional_probability_fixed(sigma2_e, power2, grids_3, theta, phi, lambda, eta)

cond_N0_S3_grids1, cond_N1_S3_grids1 = shared_conditional_probability_fixed(sigma2_e, power3, grids_1, theta, phi, lambda, eta)
cond_N0_S3_grids2, cond_N1_S3_grids2 = shared_conditional_probability_fixed(sigma2_e, power3, grids_2, theta, phi, lambda, eta)
cond_N0_S3_grids3, cond_N1_S3_grids3 = shared_conditional_probability_fixed(sigma2_e, power3, grids_3, theta, phi, lambda, eta)

cond_N0_S4_grids1, cond_N1_S4_grids1 = shared_conditional_probability_fixed(sigma2_e, power4, grids_1, theta, phi, lambda, eta)
cond_N0_S4_grids2, cond_N1_S4_grids2 = shared_conditional_probability_fixed(sigma2_e, power4, grids_2, theta, phi, lambda, eta)
cond_N0_S4_grids3, cond_N1_S4_grids3 = shared_conditional_probability_fixed(sigma2_e, power4, grids_3, theta, phi, lambda, eta)

cond_N0_S5_grids1, cond_N1_S5_grids1 = shared_conditional_probability_fixed(sigma2_e, power5, grids_1, theta, phi, lambda, eta)
cond_N0_S5_grids2, cond_N1_S5_grids2 = shared_conditional_probability_fixed(sigma2_e, power5, grids_2, theta, phi, lambda, eta)
cond_N0_S5_grids3, cond_N1_S5_grids3 = shared_conditional_probability_fixed(sigma2_e, power5, grids_3, theta, phi, lambda, eta)
...
R"""
fig_path = "//Users/yunzheli/Research/BNPJoint/figs/prior/analysis3/"
...
surv_dens1, surv_surv1, gap_dens1, gap_surv1 = shared_density_fixed(sigma2_e, power1, grids, theta, phi, lambda, eta) 
surv_dens2, surv_surv2, gap_dens2, gap_surv2 = shared_density_fixed(sigma2_e, power2, grids, theta, phi, lambda, eta) 
surv_dens3, surv_surv3, gap_dens3, gap_surv3 = shared_density_fixed(sigma2_e, power3, grids, theta, phi, lambda, eta) 
surv_dens4, surv_surv4, gap_dens4, gap_surv4 = shared_density_fixed(sigma2_e, power4, grids, theta, phi, lambda, eta) 
surv_dens5, surv_surv5, gap_dens5, gap_surv5 = shared_density_fixed(sigma2_e, power5, grids, theta, phi, lambda, eta) 
@rput grids 
@rput surv_dens1 surv_surv1 gap_dens1 gap_surv1
@rput surv_dens2 surv_surv2 gap_dens2 gap_surv2
@rput surv_dens3 surv_surv3 gap_dens3 gap_surv3
@rput surv_dens4 surv_surv4 gap_dens4 gap_surv4
@rput surv_dens5 surv_surv5 gap_dens5 gap_surv5
R"""
...
n = 400
survivals1, gaps1, arrivals1 = shared_data_generator_fixed(sigma2_e, power1, theta, phi, lambda, eta, n)
survivals2, gaps2, arrivals2 = shared_data_generator_fixed(sigma2_e, power2, theta, phi, lambda, eta, n)
survivals3, gaps3, arrivals3 = shared_data_generator_fixed(sigma2_e, power3, theta, phi, lambda, eta, n)
survivals4, gaps4, arrivals4 = shared_data_generator_fixed(sigma2_e, power4, theta, phi, lambda, eta, n)
survivals5, gaps5, arrivals5 = shared_data_generator_fixed(sigma2_e, power5, theta, phi, lambda, eta, n)
