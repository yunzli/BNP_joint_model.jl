...
include(package_dir*"src/cov/update_L.jl")
include(package_dir*"src/cov/update_surv_mixing.jl") 
include(package_dir*"src/cov/update_surv_hyper.jl") 
include(package_dir*"src/cov/update_alpha.jl") 
include(package_dir*"src/cov/update_U.jl")
include(package_dir*"src/cov/update_gap_mixing.jl") 
include(package_dir*"src/cov/update_gap_hyper.jl") 
include(package_dir*"src/cov/update_zeta.jl") 
include(package_dir*"src/cov/update_re.jl")
...
function MCMC(config_file)
	...
	cur = Dict(
        ...
        "epsilon" => ones(n),
        "xi" => ones(n),
        "Sigma_e" => 0.01 * Matrix(Diagonal(ones(2)))
		)
